...
| [docs/android-intents.md](docs/android-intents.md)                   | Share sheet, text selection, `paseo://` automation links, launcher shortcuts, the assistant provider, and the rules they follow |
