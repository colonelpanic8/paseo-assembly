...
interface StatusWorkspaceListProps {
  ...
  /** Project icon data URIs keyed by projectViewKey; null when the project has no icon. */
  iconDataByProjectViewKey: ReadonlyMap<string, string | null>;
  ...
  const content = (
    <LayoutAnimationConfig skipEntering>
      ...
      <StatusGroupList
        ...
        iconDataByProjectViewKey={iconDataByProjectViewKey}
